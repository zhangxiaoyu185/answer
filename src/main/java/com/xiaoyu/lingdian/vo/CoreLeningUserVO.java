 ...
 * @history:
 */
public class CoreLeningUserVO implements BaseVO {
    /**
     * 标识UNID
     */
    ...
    public void convertPOToVO(Object poObj) {
        ...
        CoreLeningUser po = (CoreLeningUser) poObj;
        this.crlurUuid = po.getCrlurUuid();
        this.crlurLening = po.getCrlurLening();
        this.crlurUser = po.getCrlurUser();
    }
}