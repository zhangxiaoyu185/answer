 ...
 * @history:
 */
public class CorePapersAnswerVO implements BaseVO {
    /**
     * 标识UNID
     */
    ...
    public void convertPOToVO(Object poObj) {
        ...
        this.crpsaLening = po.getCrpsaLening();
        this.crpsaPaper = po.getCrpsaPaper();
        this.crpsaUser = po.getCrpsaUser();
        this.crpsaPaperScore = po.getCrpsaPaperScore();
        this.crpsaScore = po.getCrpsaScore();
        this.crpsaQuestion = po.getCrpsaQuestion();
        this.crpsaExpire = po.getCrpsaExpire();
        this.crpsaStatus = po.getCrpsaStatus();
        this.crpsaCdate = po.getCrpsaCdate();
        this.crpsaUdate = po.getCrpsaUdate();
        this.crpesName = po.getCrpesName();
        this.crlngName = po.getCrlngName();
