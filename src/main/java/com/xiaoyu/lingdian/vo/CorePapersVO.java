...
public class CorePapersVO implements BaseVO {
    ...
    public void convertPOToVO(Object poObj) {
        ...
        this.crpesLening = po.getCrpesLening();
        this.crpesName = po.getCrpesName();
        this.crpesExpire = po.getCrpesExpire();
        this.crpesQuestion = po.getCrpesQuestion();
        this.crpesScore = po.getCrpesScore();
        this.crpesCdate = po.getCrpesCdate();
        this.crpesUdate = po.getCrpesUdate();
        this.crpesStatus = po.getCrpesStatus();
        this.crpesOpen = po.getCrpesOpen();
